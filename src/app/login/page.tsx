...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // REMARQUE : Remplacez cette URL par votre endpoint d'authentification
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a23] py-12 px-4 sm:px-6 lg:px-8">
